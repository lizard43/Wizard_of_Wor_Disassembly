...
; module. The six-byte header interface supplies speech tables, coinage data,
...
;
; This cleanup preserves the original ROM image byte-for-byte.
;==============================================================================
...
; German speech fragment $00 = "zzz-unk"
...
;==============================================================================
LC200:  DB      $29             ; Number of encoded SC-01 bytes in this fragment
...
LC22A:  DB      $30             ; Number of encoded SC-01 bytes in this fragment
...
; German speech fragment $03 = ""
; Data = Y-H-H-B-I3-N-D-A1-R
LC307:  DB      $09
        DB      $29,$1B,$1B,$0E,$09,$0D,$1E,$06
        DB      $2B

; German speech fragment $22 = ""
...
; German speech fragment $09 = ""; remapped to fragment $40 when $D350 is nonzero
; Data = W-O-R-Y-ER-PAuse1
LC462:  DB      $06
        DB      $2D,$26,$2B,$29,$3A,$3E

; German speech fragment $1A = ""
...
; German speech fragment $19 = ""
; Data = D-A1-R
LC7F2:  DB      $03
        DB      $1E,$06,$2B

; German speech fragment $53 = ""
; Data = B-E1-D-AH2-N-K-T-PAuse0-S-Y-H-H-PAuse1
LC7F6:  DB      $0D
        DB      $0E,$3C,$1E,$08,$0D,$19,$2A,$03
        DB      $1F,$29,$1B,$1B,$3E

; German speech fragment $29 = ""
...
; German speech fragment $37 = ""; remapped to fragment $41 when $D350 is nonzero
; Data = ^W-O-R-Y-ER-PAuse1-^PAuse0
LCA50:  DB      $07
        DB      $AD,$26,$2B,$29,$3A,$3E,$83

; German speech fragment $38 = ""
; Data = D-A1-R
LCA58:  DB      $03
        DB      $1E,$06,$2B

; German speech fragment $52 = ""
...
; end of German speech fragments

; as pointed to by X11_Speech_Fragment_Table_Ptr:
...
; little-endian pointer from this table. The German table has five more
; fragments than the 79-entry English table; phrase records remain compatible
; because they carry language-local fragment indexes.
;==============================================================================
German_Speech_Fragment_Pointers:
        DW      LC200            ; fragment $00
        DW      LC22A            ; fragment $01
        DW      LC26C            ; fragment $02
        DW      LC307            ; fragment $03
        DW      LC284            ; fragment $04
        DW      LC294            ; fragment $05
        DW      LC2BE            ; fragment $06
        DW      LC2E3            ; fragment $07
        DW      LC441            ; fragment $08
        DW      LC462            ; fragment $09
        DW      LC5BA            ; fragment $0A
        DW      LC5D0            ; fragment $0B
        DW      LC5E0            ; fragment $0C
        DW      LC5F4            ; fragment $0D
        DW      LC600            ; fragment $0E
        DW      LC632            ; fragment $0F
        DW      LC65E            ; fragment $10
        DW      LC669            ; fragment $11
        DW      LC694            ; fragment $12
        DW      LC6C4            ; fragment $13
        DW      LC6F6            ; fragment $14
        DW      LC716            ; fragment $15
        DW      LC753            ; fragment $16
        DW      LC789            ; fragment $17
        DW      LC7BE            ; fragment $18
        DW      LC7F2            ; fragment $19
        DW      LC469            ; fragment $1A
        DW      LC42E            ; fragment $1B
        DW      LC49C            ; fragment $1C
        DW      LC4D3            ; fragment $1D
        DW      LC504            ; fragment $1E
        DW      LC529            ; fragment $1F
        DW      LC588            ; fragment $20
        DW      LC559            ; fragment $21
        DW      LC311            ; fragment $22
        DW      LC33E            ; fragment $23
        DW      LC364            ; fragment $24
        DW      LC3A5            ; fragment $25
        DW      LC3DE            ; fragment $26
        DW      LC3FB            ; fragment $27
        DW      LC9B4            ; fragment $28
        DW      LC804            ; fragment $29
        DW      LC82E            ; fragment $2A
        DW      LC850            ; fragment $2B
        DW      LC88E            ; fragment $2C
        DW      LC8B7            ; fragment $2D
        DW      LC8D5            ; fragment $2E
        DW      LC90B            ; fragment $2F
        DW      LC93B            ; fragment $30
        DW      LC965            ; fragment $31
        DW      LC984            ; fragment $32
        DW      LC9E0            ; fragment $33
        DW      LCA19            ; fragment $34
        DW      LC485            ; fragment $35
        DW      LC6B8            ; fragment $36
        DW      LCA50            ; fragment $37
        DW      LCA58            ; fragment $38
        DW      LCA6F            ; fragment $39
        DW      LCA8C            ; fragment $3A
        DW      LCAAB            ; fragment $3B
        DW      LCAD3            ; fragment $3C
        DW      LCB01            ; fragment $3D
        DW      LCB22            ; fragment $3E
        DW      LCB52            ; fragment $3F
        DW      LC73F            ; fragment $40
        DW      LC748            ; fragment $41
        DW      LCB65            ; fragment $42
        DW      LCB9A            ; fragment $43
        DW      LCBBC            ; fragment $44
        DW      LCBE8            ; fragment $45
        DW      LCC12            ; fragment $46
        DW      LCC53            ; fragment $47
        DW      LCC72            ; fragment $48
        DW      LCC99            ; fragment $49
        DW      LCCD4            ; fragment $4A
        DW      LCD0A            ; fragment $4B
        DW      LCD4B            ; fragment $4C
        DW      LCD6C            ; fragment $4D
        DW      LC25B            ; fragment $4E
        DW      $0000            ; fragment $4F ; null/unused pointer
        DW      LC279            ; fragment $50
        DW      LC574            ; fragment $51
        DW      LCA5C            ; fragment $52
        DW      LC7F6            ; fragment $53
...
; preserving the same language-independent phrase ID.
;==============================================================================
